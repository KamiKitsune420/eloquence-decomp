...
cl %CF% /Fo%B%\ %RT% klatt.c klatt_guest.c framer.c framer_guest.c rules.c rules_ops.c rules_delta.c rules_pool.c rules_edit.c rules_guest.c rules_io.c tracks.c gen\prologues.c eloq_run.c %B%\enu\*.obj /Fe:%B%\eloq_run.exe || exit /b 1
goto :eof
