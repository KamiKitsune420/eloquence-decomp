...
def main():
    ...
    # klatt.c: the synthesizer, framer.c: the frame builder, ported by hand (klatt_guest.c and framer_guest.c
    # put them where FUN_1013caf0 and FUN_101306b0 were)
    cmds.append("cl %s %s /Fo..\\build\\%s\\ x86rt.c fx80.c x87math.c crt.c image.c klatt.c klatt_guest.c framer.c framer_guest.c eloq_run.c ..\\build\\%s\\enu\\*.obj "
    ...
    if embedded:
        ...
        cmds.append("cl %s /Oy- /DELOQ_EMBEDDED /LD /Fo..\\build\\%s\\ eci.c eci_text.c voicefx.c engine.c klatt.c klatt_guest.c framer.c framer_guest.c x86rt.c fx80.c "
